...
public class PageDTO {
	...
	public PageDTO(int totalCount, String pageNum) {
	...
	public Map<String, Object> getMapInfo(){
		Map<String, Object> mapInfo = new HashMap<String, Object>() {{
			System.out.println("contentBegin: " + contentBegin);
...
//	public Map<String, Boolean> getBtnInfo(){
//		Map<String, Boolean> btnInfo = new HashMap<String, Boolean>() {{
//			put("prev", btnPrev);
//			put("next", btnNext);
//		}};
//		return btnInfo;
